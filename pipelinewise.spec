...
datas = [('pipelinewise/logging.conf', 'pipelinewise/'), ('pipelinewise/logging_debug.conf', 'pipelinewise/'), ('pipelinewise/cli/schemas', 'pipelinewise/cli/schemas'), ('pipelinewise/cli/samples', 'pipelinewise/cli/samples'), ('pipelinewise/fastsync', 'pipelinewise/fastsync')]
binaries = []
hiddenimports = ['pipelinewise.fastsync.postgres_to_postgres', 'pipelinewise.fastsync.commons.tap_postgres', 'pipelinewise.fastsync.commons.target_postgres', 'psycopg2', 'psycopg2._psycopg', 'psycopg2.extensions', 'requests', 'tap_postgres', 'target_postgres']
...
datas += collect_data_files('cloudpickle')
...
datas += copy_metadata('ansible-core')
datas += copy_metadata('pipelinewise-tap-postgres')
datas += copy_metadata('pipelinewise-target-postgres')
datas += copy_metadata('psycopg2-binary')
binaries += collect_dynamic_libs('psycopg2')
hiddenimports += collect_submodules('pipelinewise')
hiddenimports += collect_submodules('pipelinewise.cli')
...
hiddenimports += collect_submodules('cloudpickle')
